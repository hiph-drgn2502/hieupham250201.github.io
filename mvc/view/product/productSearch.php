...
?>
            <div class="row">
                ...
                data-aos-once="true" class="text-center mb-60">
                    <h2>
                        <?php echo "Tìm thấy ".$totalRecords." sản phẩm." ?>
                    </h2>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 center-product">
                        <div data-aos="fade-up" class="card text-center" style="width: 18rem; min-height: 500px;">
                            ...
                            <div class="card-body">
                                ...
                                <?php } ?>
                                <div class="fb-like" data-href="<?php echo BASE_URL.'product/productDetail/'.$currentproduct['alias'] ?>" data-width="" data-layout="button_count" data-action="like" data-size="small" data-share="true"></div>
