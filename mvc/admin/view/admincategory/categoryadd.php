        ...
        <div class="card-body">
            ...
            <form class="forms-sample" method="post" action="" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputName1" placeholder="Category Name" name="inputCatName" required> 
                </div>
                <div class="form-group">
                ...
                <!-- <div class="form-group">
                    <label for="exampleInputPassword4">ParentId</label>
                    <div class="col-sm-9">
                        <select class="form-control form-control-lg" id="exampleFormControlSelect1" name="inputParentId">
