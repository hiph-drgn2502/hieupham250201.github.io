          ...
          <?php $i=1;
           foreach($pages as $p){?>
            <tr>
              ...
              <td class="text-danger"> <?php echo $p['createDate']?></td>
              <td class="text-danger"> <?php echo $p['updateDate']?></td>
              <td class="text-danger"> <?php echo $p['trash']?></td>
              <td><a href="<?php echo BASE_URL?>adminpage/pageToggleTrash/<?php echo $p['pageId']?>" onclick="return confirm('Bạn có muốn chắc xóa thông tin web này ?')"><i class="fa fa-trash-o text-danger"></i></a>
                |<a href="<?php echo BASE_URL?>adminpage/updatepage/<?php echo $p['pageId']?>"><i class="fa fa-wrench text-primary"></i></a></td>
            </tr>
          <?php }?>
        </tbody>
      </table>
