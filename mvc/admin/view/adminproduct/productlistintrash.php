          ...
          <?php $i=1;
           foreach($products as $p){?>
            <tr>
              ...
              <td><a href="<?php echo BASE_URL?>adminproduct/productDelete/<?php echo $p['productid']?>" onclick="return confirm('Bạn có muốn chắc xóa vĩnh viễn sản phẩm này ?')"><i class="fa fa-times-circle text-danger"></i></a>
                |<a href="<?php echo BASE_URL?>adminproduct/productToggleTrash/<?php echo $p['productid']?>"><i class="fa fa-undo text-primary"></i></a></td>
            </tr>
          <?php }?>
        </tbody>
      </table>
