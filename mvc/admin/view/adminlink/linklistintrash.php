          ...
          <?php $i=1;
           foreach($links as $l){?>
            <tr>
              ...
              <td><a href="<?php echo BASE_URL?>adminlink/linkDelete/<?php echo $l['id']?>" onclick="return confirm('Bạn có muốn chắc xóa vĩnh viễn liên kết này ?')"><i class="fa fa-times-circle text-danger"></i></a>
                |<a href="<?php echo BASE_URL?>adminlink/linkToggleTrash/<?php echo $l['id']?>"><i class="fa fa-undo text-primary"></i></a></td>
            </tr>
          <?php }?>
        </tbody>
      </table>
