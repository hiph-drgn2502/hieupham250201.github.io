          ...
          <?php $i=1;
           foreach($slides as $s){?>
            <tr>
              ...
              <td><a href="<?php echo BASE_URL?>adminslide/slideToggleTrash/<?php echo $s['id']?>" onclick="return confirm('Bạn có muốn chắc xóa hình ảnh này ?')"><i class="fa fa-trash-o text-danger"></i></a>
                |<a href="<?php echo BASE_URL?>adminslide/updateslide/<?php echo $s['id']?>"><i class="fa fa-wrench text-primary"></i></a></td>
            </tr>
          <?php }?>
        </tbody>
      </table>
